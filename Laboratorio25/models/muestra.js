...
module.exports = class Muestra {
    ...
    constructor(mi_nombre, mi_funcion, miindice_bodega, mi_imagen) {
    ...
    save() {
        ...
        return db.execute('INSERT INTO muestras (nombre, funcion, indice_bodega, imagen) VALUES (?, ?, ?, ?)',
            [this.nombre, this.funcion, this.indice_bodega, this.imagen]
        );
    }
