...
router.get('', (request, response, next) => {
    ...
    menu += '<header><h3><strong>Bienvenido al Laboratorio 12:</strong></h3></header><header><h4><strong>Menú</strong></h4></header><li><a href="/phishing">Sitio simple de phishing</a></li><li><a href="/labs">Laboratorios 7 y 12(pregunta respondida)</a></li>';
